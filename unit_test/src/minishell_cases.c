...
MINISHELL_TEST(execution_builtins, "pwd\ncd ..\npwd");
...
MINISHELL_TEST(pipe_after_9, "ls |");
MINISHELL_TEST(pipe_after_6, "ls | \"\"");
MINISHELL_TEST(pipe_after_2, "ls | >");
MINISHELL_TEST(pipe_after_1, "ls | <");
MINISHELL_TEST(pipe_after_8, "ls |");
MINISHELL_TEST(pipe_after_4, "ls | >>");
MINISHELL_TEST(pipe_after_7, "ls | |");
MINISHELL_TEST(pipe_after_5, "ls | \'\'");
MINISHELL_TEST(pipe_after_3, "ls | <<");
...
MINISHELL_TEST(pipe_before_9, "| ls");
MINISHELL_TEST(pipe_before_6, "\"\" | ls");
MINISHELL_TEST(pipe_before_2, "> | ls");
MINISHELL_TEST(pipe_before_1, "< | ls");
MINISHELL_TEST(pipe_before_8, "| ls");
MINISHELL_TEST(pipe_before_4, ">> | ls");
MINISHELL_TEST(pipe_before_7, "| | ls");
MINISHELL_TEST(pipe_before_5, "\'\' | ls");
MINISHELL_TEST(pipe_before_3, "<< | ls");
...
MINISHELL_TEST(mkdir_rmdir, "mkdir test\nrmdir test");
MINISHELL_TEST(mkdir_file_exists, "rmdir test\nmkdir test\nmkdir test\nrmdir test");
